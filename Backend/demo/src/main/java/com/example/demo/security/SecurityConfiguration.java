...
<<<<<<< HEAD
		.requestMatchers(HttpMethod.POST, "/user","/petition","/donations")//, "/tip")//(HttpMethod.POST, "/user", "/tip")//.requestMatchers( HttpMethod.GET, "/tip")
=======
...
>>>>>>> 5f382deb46b6140537b5559682c6d6ccafd88f1c
//	    .and()
