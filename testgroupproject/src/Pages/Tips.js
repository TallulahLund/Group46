...
//     const orderSort = useRef("Newest First");// had to put before useeffe         // default order is newest firstct
//     useEffect(() => {
...
export default function Tips(){
    ...
    function custom_sort_old(a, b) {                                // oldest first tip sort
    ...
    function testsort(a, b)                                         // sorts most + least first
    {
      return b - a;
    }
    ...
    const displayAllTipData = () => {                               // displays all tips
        ...
        if (orderSort.current.value === "Newest First" && allTipData !== "")
        {
            console.log("in ordersort check nf ", allTipData.updatedAt, ".");
                // allTipData.sort(custom_sort);
                mappingAllTipData.sort(custom_sort);
        }
        else if (orderSort.current.value === "Most Popular" && allTipData !== "")
        {
            console.log("in most popular");
        ...
        else if (orderSort.current.value === "Oldest First" && allTipData !== "")
        {
            mappingAllTipData.sort(custom_sort_old);
        }
        else // will be original which is Oldest First
        {
