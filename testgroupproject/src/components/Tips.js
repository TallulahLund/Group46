...
import bin from './delete bin.jpg';
...
export default function Tips(){
    ...
    return (
        ...
        <section className="mainContent">
            <section>
                <h3>Energy Saving Tips</h3><br/>
                <p>We know not everyone can afford to switch to better renewable energy yet, so here's some tips to help you out saving energy and money for energy.</p>
            </section>
                ...
                <div className="tab-content">
                    ...
                    <div className="tabs_tab active" id="tab_1" data-tab-info>
                        ...
                        <div className="tipLine">
                            <div className="tip">
                                <div className="beforeH">
                                    <span><h4>Leaving the room?<br/><br/>Turn it off</h4></span>
                                    <img src={lightbulb} alt="lightbulb" id="lightbulb"/>
                                </div>
                                <div className="afterH">Turning lights off when you leave the room or are simply not using them could save you £25 per year on energy bills</div>
                            </div>
                            <div className="tip">
                                <div className="beforeH">
                                    <span><strong>Not using it?<br/><br/>Unplug it</strong></span>
                                </div>
                                <div className="afterH">If you're not using your electrical devices, make sure you unplug them</div>
                            </div>
                        </div>
                        ...
                        <div className="tipLine">
                            <div className="tip">
                                <div className="beforeH">
                                    <span><strong>At 100%?<br/><br/>Stop charging it</strong></span>
                                </div>
                                <div className="afterH">Make sure you unplug when your devices reach full-charge</div>
                            </div>
                            <div className="tip">
                                <div className="beforeH">
                                    <span><strong>Use an air dryer<br/><br/>Not a tumble dryer</strong></span>
                                </div>
                                <div className="afterH">Don't use the tumble dryer when it's not necessary, hanging clothes on drying racks could save £70 a year</div>
                            </div>
                        </div>
                        ...
                        <div className="tipLine">
                            <div className="tip">
                                <div className="beforeH">
                                    <span><strong>Shower don't Bathe<br/></strong></span>
                                    <img src={shower} alt="shower" id="shower"/>
                                </div>
                                <div className="afterH">Swapping just one bath for a short shower a week could save £20 a year</div>
                            </div>
                            <div className="tip">
                                <div className="beforeH">
                                    <span><strong>Use Kettles wisely<br/><br/>Avoid overfilling</strong></span>
                                    <img src={kettle} alt="kettle" id="kettle"/>
                                </div>
                                <div className="afterH">Using just the right amount of water when boiling your kettle could save £13 a year</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="allTips">
                            ...
                            <div className="tipBoxes">
                                ...
                                <div className="tipBox">
                                    ...
                                    <span className="tipCategory"><p>Home</p></span>
                                    ...
                                    <span className="tipString">
                                        <p>Remember to keep all windows and doors close to stop heat escaping.</p>
                                    </span>
                                    <span className="likes">
                    ...
                    <div className="tabs_tab" id="tab_3" data-tab-info>
                        <span>You currently have </span><span>2</span><span> tips posted.</span>
                        ...
                        <div className="submitTips">
                            ...
                            <div id="textArea">
                                <textarea id="tA" placeholder="Enter your Tip here..." ></textarea>
                            </div>
                            <div id="tipButtonDiv">
                        ...
                        <div className="userTips">
                            ...
                            <br/><p><strong>Your Tips:</strong></p>
                            {/* <br/> */}
                                        ...
                                        <div className="userTipBoxN">
                                            <span className="userTipInfoN">
                                                <div className="firstLine">
                                                    <span className="tipCategory"><p>Home</p></span>
                                                    <span className="postInfo">
                                                        <span className="tipDateTime"> posted - 06/01/2023 15:28</span>
                                                    </span>
                                                </div>
                                                <div className="secondLine">
                                                    <span className="userTipString">
                                                        <p>Only turn the heating on when it's necessary, layer up clothing instead.</p>
                                                    </span>
                                                    <span className="userLikes">
                                                        <span className="userTipLikes">
                                                            <p>207 Likes</p>
